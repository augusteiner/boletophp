...
$dadosboleto = array(
    "nosso_numero" => "1234567",  // Nosso numero - REGRA: Máximo de 7 caracteres!
    "numero_documento" => "12345",    // Num do pedido ou nosso numero
...
// DADOS PERSONALIZADOS - Banespa
    "codigo_cedente" => "40013012168", // Código do cedente (Somente 11 digitos)
    "ponto_venda" => "400", // Ponto de Venda = Agencia 
    "carteira" => "COB",  // COB - SEM Registro
    "nome_da_agencia" => "ACLIMAÇÃO",  // Nome da agencia (Opcional)
