...
$dadosboleto = array(
    "nosso_numero" => "3020",          // Nosso numero - REGRA: Máximo de 13 números p/ carteira 57 (Sem registro), e 7 números p/ carteira 20 (Com registro)
    "numero_documento" => "1234567",          // Número do pedido ou do documento (A seu critério)
...
// DADOS DA SUA CONTA - SUDAMERIS
    "agencia" => "0501",          // Número da agencia, sem digito
    "conta" => "6703255",     // Número da conta, sem digito
    "carteira" => "57",          // Deve possuir convênio - Carteira 57 (Sem Registro) ou 20 (Com Registro)
