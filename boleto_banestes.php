...
$dadosboleto = array(
    "nosso_numero" => "21487805",  // Nosso numero sem o DV - REGRA: Máximo de 8 caracteres!
    "numero_documento" => "18.030299.01",    // Num do pedido ou do documento
...
// DADOS DA SUA CONTA - BANESTES
    "conta" => "1.222.333",     // Num da conta corrente
    "agencia" => "123",         // Num da agência

// DADOS PERSONALIZADOS - BANESTES
    "carteira" => "00", // Carteira do Tipo COBRANÇA SEM REGISTRO (Carteira 00) - Não é Carteira 11
    "tipo_cobranca" => "2",  // 2- Sem registro, 
                                      // 3- Caucionada; 
