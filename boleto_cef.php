...
$dadosboleto = array(
    "inicio_nosso_numero" => "80",  // Carteira SR: 80, 81 ou 82  -  Carteira CR: 90 (Confirmar com gerente qual usar)
    "nosso_numero" => "19525086",  // Nosso numero sem o DV - REGRA: Máximo de 8 caracteres!
...
// DADOS PERSONALIZADOS - CEF
    "conta_cedente" => "87000000414", // ContaCedente do Cliente, sem digito (Somente Números)
    "conta_cedente_dv" => "3", // Digito da ContaCedente do Cliente
