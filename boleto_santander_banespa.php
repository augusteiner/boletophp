...
$dadosboleto = array(
    "nosso_numero" => "1234567",  // Nosso numero sem o DV - REGRA: Máximo de 7 caracteres!
...
// DADOS PERSONALIZADOS - SANTANDER BANESPA
    "codigo_cliente" => "0707077", // Código do Cliente (PSK) (Somente 7 digitos)
    "ponto_venda" => "1333", // Ponto de Venda = Agencia
    "carteira" => "102",  // Cobrança Simples - SEM Registro
    "carteira_descricao" => "COBRANÇA SIMPLES - CSR",  // Descrição da Carteira
