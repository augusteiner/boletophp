...
$dadosboleto = array(
    "inicio_nosso_numero" => "99",  // Inicio do Nosso numero -> 99 - Cobrança Direta(Carteira 5) ou 0 - Cobrança Simples(Carteira 1)
    "nosso_numero" => "0000020",  // Nosso numero sem o DV - REGRA: Máximo de 7 caracteres!
...
// DADOS DA SUA CONTA - NOSSA CAIXA
    /*"agencia" => "0033", // Num da agencia, sem digito
    "conta" => "0001131",     // Num da conta, sem digito
    "conta_dv" => "1",     // Digito do Num da conta*/

// DADOS PERSONALIZADOS - CEF
    "agencia" => "0033", // Num da agencia, sem digito
    "conta_cedente" => "001131", // ContaCedente do Cliente, sem digito (Somente 6 digitos)
    "conta_cedente_dv" => "1", // Digito da ContaCedente do Cliente
    "carteira" => "5",  // Código da Carteira -> 5-Cobrança Direta ou 1-Cobrança Simples
    "modalidade_conta" => "04",  // modalidade da conta 02 posições
