...
$dadosboleto = array(
    "campo_fixo_obrigatorio" => "1",       // campo fixo obrigatorio - valor = 1 
    "inicio_nosso_numero" => "9",          // Inicio do Nosso numero - obrigatoriamente deve começar com 9,
    "nosso_numero" => "19525086",  // Nosso numero sem o DV - REGRA: Máximo de 16 caracteres! (Pode ser um número sequencial do sistema, o cpf ou o cnpj)
...
// DADOS PERSONALIZADOS - CEF
    "conta_cedente" => "057335", // ContaCedente do Cliente, sem digito (Somente Números)
