...
$nnum = $dadosboleto["inicio_nosso_numero"] . $this->formata_numero($dadosboleto["nosso_numero"],17,0);
//dv do nosso número
...
$dv = $this->digitoVerificador_barra("$codigobanco$nummoeda$fator_vencimento$valor$campo_livre", 9, 0);
