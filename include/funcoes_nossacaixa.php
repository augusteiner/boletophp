...
//modalidade da conta
$modalidade = $this->formata_numero($dadosboleto["modalidade_conta"],2,0);
...
$nnum = $dadosboleto["inicio_nosso_numero"] . $this->formata_numero($dadosboleto["nosso_numero"],7,0);
...
$dv_nosso_numero = $this->digitoVerificador_nossonumero($nnum,$conta_cedente,$conta_cedente_dv,$agencia,$modalidade);
...
$dv1 = $this->geraDv43($calcdv1);
$dv2 = $this->geraDv44("$calcdv1$dv1");
...
$dv = $this->digitoVerificador_barra("$codigobanco$nummoeda$fator_vencimento$valor$prefixo$nnum$ag_contacedente$codigobanco$dv1$dv2");
